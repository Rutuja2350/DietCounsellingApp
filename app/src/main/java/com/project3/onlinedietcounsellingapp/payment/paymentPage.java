...
public class paymentPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("ClientInfo").document(userId);  //retrieving data using userID
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {

                amount.setText(documentSnapshot.getString("amount"));
                if (documentSnapshot.getString("amount")=="1000"){
                    note.setText("Making payment for 1 month package at nitroHub");
                }
                if (documentSnapshot.getString("amount")=="2500"){
                    note.setText("Making payment for 3 months package at nitroHub");
                }
            }
        });
    ...
    void payUsingUpi(  String name,String upiId, String note, String amount) {
        ...
        if(null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(paymentPage.this,"No UPI app found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    }
    @Override
